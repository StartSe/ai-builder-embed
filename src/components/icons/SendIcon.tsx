...
const defaultButtonColor = 'none';
const defaultButtonBorderColor = 'none';
const defaultStrokeWidth = 32;
export const SendIcon = (props: JSX.SvgSVGAttributes<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="19px" {...props}>
    <path
      fill={props.color ?? defaultButtonColor}
      stroke={props.stroke ?? defaultButtonBorderColor}
