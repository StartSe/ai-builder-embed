...
export const Bot = (props: BotProps & { class?: string }) => {
  ...
  return (
    <>
      <div
        ref={botContainer}
        class={'relative flex w-full h-[calc(100vh-147px)] text-base overflow-hidden bg-cover bg-center flex-col items-center chatbot-container ' + props.class}>
        <div class="flex w-full h-[calc(100vh-147px)] justify-center">
          <div
            ref={chatContainer}
            class="overflow-y-scroll min-w-full w-full min-h-[calc(100vh-163px)] px-3 pt-20 relative scrollable-container chatbot-chat-view scroll-smooth">
            <For each={[...messages()]}>
              {(message, index) => (
                <>
